...
\setlength{\columnheight}{82cm} % ------------------------------- od jakiej wysokości mają zaczynać się klocki, ale też miejsce dla tytułu autorów, afiliacji
...
\begin{figure}
  \includegraphics[width=1\columnwidth]{figure/sequence_1.png}
  \caption{Sequence reconstruction and basic information}
\end{figure}

\begin{figure}
  \includegraphics[width=1\columnwidth]{figure/sequence_2.png}
...
\item [6] The Utility of Hydrogen/Deuterium Exchange Mass Spectrometry in Biopharmaceutical Comparability Studies. Houde, D.et al.(2011). Journal of pharmaceutical sciences,100(6), 2071–2086
\end{enumerate}
\end{block}
